...
@ServerEndpoint("/websocket/running-agents")
@Startup
@Singleton
@LocalBean
public class WebSocketAgentsEndpoint {
	...
	public void syncRunningAgents(Collection<AID> runningAgents) {
		if(connections != null) {
			for(Session session: connections) {
				Gson gson = new GsonBuilder().create();
				String message = gson.toJson(runningAgents);
